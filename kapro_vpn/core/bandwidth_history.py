...
Why SQLite (vs. JSON / pickle / flat file):
  ...
  - Atomic writes per INSERT — if KaproVPN crashes mid-write, the
...
What's NOT recorded:
  ...
  - times when KaproVPN was running but disconnected
  - times when KaproVPN was closed (no measurement possible)
